...
\datedEntry{
    ...
    \subtitledSubsection{Counsyl}{%
        Automation Specialist $\Rightarrow$
        Automation Service Engineer $\Rightarrow$
    ...
    \begin{itemize}
        ...
        \end{itemize}%
        \item Software development - full stack
        \begin{itemize}%
            \item Front and back-end development with Python and Django; platform with Puppet
        \end{itemize}%
        \item Developed PLC (programmable logic controller) software and HMI design
        \item Performed troubleshooting on hardware/software issues to identify root cause, provide fixes
    \end{itemize}
}
\divLine
\datedEntry{
