...
\datedEntry{
    ...
    \begin{itemize}
        ...
        \begin{itemize}%
            \item Designed mechanical parts and assemblies in SolidWorks - DFM, DFA, part selection
            \item Performed prototyping and testing to validate and de-risk
            \item Created multiple novel designs - one patent application
        \end{itemize}%
