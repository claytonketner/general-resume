...
\begin{tabu}{ L{\tabularIndent} X } \hhline{==}
	...
	&
	Computer aided design (+FEA), linear control systems, dynamic systems, vibrations, advanced strength of materials, engineering algorithms, robotics algorithms, artificial intelligence
...
\\ \hhline{==}
	...
	\end{tabular}
	\\
	& Transfer to USC -- Statics, dynamics, strength of materials
\end{tabu}}